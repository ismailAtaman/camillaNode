...
async loadAutoEQDB(source) {    
    ...
    async getCongifText(url) {
        await fetch(url).then((res)=>res.text().then(data=>{return data}));
    }
    

    async downloadHeadphoneList() {
